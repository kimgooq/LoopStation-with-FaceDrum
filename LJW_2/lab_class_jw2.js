  ...
  const rightarmiks = [
    {
        target: 36, // "target"
        effector: 35, // "bone3"
        links: [{ index: 34 },{ index: 33 } ] // "bone2", "bone1", "bone0"
    }
];
...
const rightlegiks = [
  {
      target: 66, // "target"
      effector: 65, // "bone3"
      links: [{ index: 64 },{ index: 63 },{ index: 62 } ] // "bone2", "bone1", "bone0"
  }
];
// console.log(skeleton.bones);
// let ikSolver = new CCDIKSolver( skeleton, rightlegiks );
let ikSolver = new CCDIKSolver( skeleton, rightarmiks );
